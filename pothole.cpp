...
// This program uses the relabel-to-front algorithm with gap heuristic.
// Measurements suggest that the FIFO vertex selection rule is faster, though.
// See fastflow.cpp for an implementation.
